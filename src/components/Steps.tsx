...
const STEPS = [
    ...
    {
        name: "Step 2: Customize desing",
        description: "Make the case yours",
        url: "/design"
    },
    {
        name: "Step 3: Summary",
        description: "Review yor final design",
        url: "/preview"
    }
]
    ...
    return <ol className="rounded-md bg-white lg:flex lg:rounded-none lg:border-l lg:border-r lg:border-gray-200">
        {STEPS.map((step, i) => {
            ...
            return (<li key={step.name} className="relative overflow-hidden lg:flex-1">
                <div>
                    <span className={cn("absolute lef-0 top-0 h-full w-1 bg-zinc-400 lg:bottom-0 lg:top-auto lg:h-1 lg:w-full", {
