...
import MeuPhone from "../components/Phone";
        ...
        <MaxWidthWrapper className="pb-24 pt-10 lg:grid lg:grid-cols-3 sm:pb-32 lg:gap-x-0 xl:gap-x-8 lg:pt-24 xl:pt-32 lg:pb-52">
          <div className="col-span-2 px-6 lg:px-0 lg:pt-4">
            <div className="relative mx-auto text-center lg:text-left flex flex-col items-center lg:items-start">
              ...
              <h1 className="relative w-fit tracking-tight text-balance mt-16 font-bold !leading-tight text-gray-900 text-5xl md:text-6xl lg:7xl">Your Image on a <span className="bg-green-900 px-2 text-white">Custom </span> Phone case</h1>
              <p className="mt-8 text-lg lg:pr-10 max-w-prose text-center lg:text-left text-balance md:text-wrap">
                Capture your favorite memories with you own, <span className="font-semibold">one-of-one</span> phone case.
          ...
          <div className="col-span-full lg:col-span-1 w-full flex justify-center px-8 sm:px-16 md:px-0 mt-32 lg:mx-0 lg:mt-20 h-fit">
            <div className="relative md:max-w-xl">
              ...
              <MeuPhone className="w-64" imgSrc="/testimonials/1.jpg" />
            </div>
          </div>
        </MaxWidthWrapper>
      </section>
      ...
      <section className="bg-slate-100 py-24">
        <MaxWidthWrapper className="flex flex-col items-center gap-16 sm:gap-32">
          <div className="flex flex-col lg:flex-row items-center gap-4 sm:gap-6">
            ...
            <img src="/snake-2.png" alt="snake 2" className="w-24 order-0 lg:order-2" />
          </div>
          <div className="mx-auto grid max-w-2xl grid-cols-1 px-4 lg:mx-0 lg:max-w-none lg:grid-cols-2 gap-y-16">
            <div className="flex fle-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              ...
              <div className="text-lg leading-8">
                <p>"The case feels durable and i even got a compliment on the design
                  , had the case for two and half months now and <span className="p-0.5 bg-slate-800 text-white">The image is super clear</span>, on the case i had before,
                  the image started fadding into yellow-ish color after a couple weeks. love it."
                </p>
              </div>
              <div className="flex gap-4 mt-2">
                ...
                <div className="flex flex-col">
                  ...
                  <div className="flex gap-1.5 items-center text-zinc-600">
                    <Check className="-5 w-5 stroke-[3px] text-green-500" />
            ...
            <div className="flex fle-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              ...
              <div className="flex gap-4 mt-2">
                ...
                <div className="flex flex-col">
                  <p className="font-semibold">Júlio</p>
                  <div className="flex gap-1.5 items-center text-zinc-600">
                    <Check className="-5 w-5 stroke-[3px] text-green-500" />
                    <p className="text-sm">Verified Purchase</p>
                  </div>
        ...
        <MaxWidthWrapper className="py-24">
          ...
          <div className="mx-auto max-w-6xl px-6 lg:px-8">
            <div className="relative flex flex-col items-center md:grid grid-cols-2 gap-40">
              ...
              <MeuPhone className="w-60" imgSrc="/horse_phone.jpg" />
            </div>
          </div>
          ...
          <ul className="mx-auto mt-12 max-w-prose sm:text-lg space-y-2 w-fit">
            ...
            <div className="flex justify-center">
              ...
              })} href="/configure/upload">Create your own case <ArrowRight className="size-5 ml-1.5" /></Link>
            </div>
          </ul>
        </MaxWidthWrapper>
      </section>
